...
namespace Demo.Controllers
{
	public class HomeController : Controller
	{
		...
		public StatusCodeResult FileUpload(IFormFile file)
		{
			...
			var uploadOptions = _fileUploadOptions;
			...
			if (!Directory.Exists(uploadOptions.FileStoragePath))
				Directory.CreateDirectory(uploadOptions.FileStoragePath);

			string filePath = Path.Combine(uploadOptions.FileStoragePath, file.FileName);
		...
		public IActionResult GetFile(string fileName)
		{
			...
			string filePath = Path.Combine(uploadOptions.FileStoragePath, fileName);
			if (System.IO.File.Exists(filePath))
			{
