...
function InitUploadZone(containerName, fileContainerWithSeparator) {
    ...
    function RenderFiles() {
        ...
        for (var i = 0; i < CurrentFiles.length; i++) {
            ...
            content += "" + "<div data-file-index='" + i + "' class='up-file'>" + "<div class='up-file-name'>" + "<a href='" + fileUrl + "' target='_blank'>" + fileName + "</a>" + "</div>" + "<div class='up-file-state'>Waiting</div>" + "<div class='clear'></div>" + "<div class='up-file-progress'></div>" + "</div>";
        }
    ...
    function UploadStep() {
        ...
        if (CurrentFiles.length > CurrentFileIndex) {
            ...
            UploadFile(Form.action, CurrentFiles[CurrentFileIndex], function (e) {
                if (container != null) {
